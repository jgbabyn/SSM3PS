...
comm_wt$'2' <-cn[,1]*sw[,1] #using cn*sw for age2 for now, Jon extrapolation migth be usefull here
...
surveys <- read.ices("C:/Users/jchampag/Documents/GitHub/SSM3PS/data_EDA/surveys-FR-GEAC-IO.txt");survey <- 'IO'
...
save(surveys,cn,mo,sw,cw,dw,lw,pf,pm,nm,lf,file=paste("C:/Users/jchampag/Documents/GitHub/SSM3PS/SAM_fit/SAMdata_",survey,".Rdata",sep=""))
